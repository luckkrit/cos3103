...
public class App {
    ...
    // ---------- PostgreSQL connection (same as your original setup) ----------
    static final String PG_URL = "jdbc:postgresql://localhost:5432/postgres";
    static final String PG_USERNAME = "postgres";
    static final String PG_PASSWORD = "password";

    // ---------- Elasticsearch ----------
    static final String ES_URL = "http://localhost:9200"; // via gh codespace tunnel if ES is on Codespaces
